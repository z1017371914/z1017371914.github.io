...
![image-20200520144548997](https://tva4.sinaimg.cn/large/0085EwgIgy1gsb82lv79kj30sm0eojst.jpg)

出现下面的页面代表成功

![image-20200520144959353](https://tvax2.sinaimg.cn/large/0085EwgIgy1gsb83zcy5mj31h30ppdi6.jpg)
...
![image-20200520154628679](https://tva1.sinaimg.cn/large/0085EwgIgy1gsb82y9fd4j31gi0atmxx.jpg)

**扩缩容**

在`Deployment`上点击`规模`，然后指定`目标副本数量`，点击确定

![image-20200520162605102](https://tvax3.sinaimg.cn/large/0085EwgIgy1gsb834dg16j317z0h4aba.jpg)

**编辑**

在`Deployment`上点击`编辑`，然后修改`yaml文件`，点击确定

![image-20200520163253644](https://tva3.sinaimg.cn/large/0085EwgIgy1gsb83bs34vj31790amwfq.jpg)

**查看Pod**

点击`Pods`, 查看pods列表

![image-20200520163552110](https://tvax3.sinaimg.cn/large/0085EwgIgy1gsb83hekh3j31g70ev417.jpg)

**操作Pod**

选中某个Pod，可以对其执行日志（logs）、进入执行（exec）、编辑、删除操作

![image-20200520163832827](https://tva2.sinaimg.cn/large/0085EwgIgy1gsb83o4m6rj316i08pwfr.jpg)
